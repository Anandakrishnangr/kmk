...
function Searchresult() {
    ...
    return (
        <div className="sear contentbody">
                ...
                <div className="container-fluid p-0 col-xl-2 col-md-2 border sidefilter ">
                    ...
                    <div>
                        <ul className="list-group ">
                            <a className="btn text-start ps-4 sidelinker">Tyre</a>
                            <a className="btn text-start ps-4 sidelinker">Electrical</a>
                            <a className="btn text-start ps-4 sidelinker">Air conditioning</a>
                            <a className="btn text-start ps-4 sidelinker">Coolant</a>
                            <a className="btn text-start ps-4 sidelinker">Alloy</a>
                            <a className="btn text-start ps-4 sidelinker">Seat</a>
                            <a className="btn text-start ps-4 sidelinker">Accesories</a>
                            <a className="btn text-start ps-4 sidelinker">Graphics</a>
                        </ul>
                    </div>
                    ...
                    <div className="row mx-2 mt-2">
                        ...
                        <div className="col-4"> <input type="button" className="form-control " value="Go"></input></div>
                    </div>
                </div>
